...
VVSS_HEFT = Lorentz(name = 'VVSS_HEFT',
                    spins = [ 3, 3, 1, 1 ],
                    structure = 'P(1,2)*P(2,1) - P(-1,1)*P(-1,2)*Metric(1,2)')

VVSSS_HEFT = Lorentz(name = 'VVSSS_HEFT',
                     spins = [ 3, 3, 1, 1, 1 ],
                     structure = 'P(1,2)*P(2,1) - P(-1,1)*P(-1,2)*Metric(1,2)')
...
VVVSS_HEFT = Lorentz(name = 'VVVSS_HEFT',
                     spins = [ 3, 3, 3, 1, 1 ],
                     structure = 'P(3,1)*Metric(1,2) - P(3,2)*Metric(1,2) - P(2,1)*Metric(1,3) + P(2,3)*Metric(1,3) + P(1,2)*Metric(2,3) - P(1,3)*Metric(2,3)')

VVVSSS_HEFT = Lorentz(name = 'VVVSSS_HEFT',
                      spins = [ 3, 3, 3, 1, 1, 1 ],
                      structure = 'P(3,1)*Metric(1,2) - P(3,2)*Metric(1,2) - P(2,1)*Metric(1,3) + P(2,3)*Metric(1,3) + P(1,2)*Metric(2,3) - P(1,3)*Metric(2,3)')
...
VVVVSS_HEFT1 = Lorentz(name = 'VVVVSS_HEFT1',
                       spins = [ 3, 3, 3, 3, 1, 1 ],
                       structure = 'Metric(1,4)*Metric(2,3) - Metric(1,3)*Metric(2,4)')

VVVVSS_HEFT2 = Lorentz(name = 'VVVVSS_HEFT2',
                       spins = [ 3, 3, 3, 3, 1, 1 ],
                       structure = 'Metric(1,4)*Metric(2,3) - Metric(1,2)*Metric(3,4)')

VVVVSS_HEFT3 = Lorentz(name = 'VVVVSS_HEFT3',
                       spins = [ 3, 3, 3, 3, 1, 1 ],
                       structure = 'Metric(1,3)*Metric(2,4) - Metric(1,2)*Metric(3,4)')

VVVVSSS_HEFT1 = Lorentz(name = 'VVVVSSS_HEFT1',
                        spins = [ 3, 3, 3, 3, 1, 1, 1 ],
                        structure = 'Metric(1,4)*Metric(2,3) - Metric(1,3)*Metric(2,4)')

VVVVSSS_HEFT2 = Lorentz(name = 'VVVVSSS_HEFT2',
                        spins = [ 3, 3, 3, 3, 1, 1, 1 ],
                        structure = 'Metric(1,4)*Metric(2,3) - Metric(1,2)*Metric(3,4)')

VVVVSSS_HEFT3 = Lorentz(name = 'VVVVSSS_HEFT3',
                        spins = [ 3, 3, 3, 3, 1, 1, 1 ],
                        structure = 'Metric(1,3)*Metric(2,4) - Metric(1,2)*Metric(3,4)')
