...
# new eft parameters
CGGeta0 =  Parameter(name = 'CGGeta0',
                nature = 'external',
                type = 'real',
                value = 0.1234,
                texname = '\\text{CGGeta0}',
...
CGGiota0 =  Parameter(name = 'CGGiota0',
                nature = 'external',
                type = 'real',
                value = 0.1235,
                texname = '\\text{CGGiota0}',
                lhablock = 'BSM',
                lhacode = [ 882 ])
...
Geta0 = Parameter(name = 'Geta0',
               nature = 'internal',
               type = 'real',
               value = '-G**2*CGGeta0/(12.*cmath.pi**2*Lambda)',
               texname = 'Geta0')

Giota0 = Parameter(name = 'Giota0',
               nature = 'internal',
               type = 'real',
               value = '-G**2*CGGiota0/(12.*cmath.pi**2*Lambda)',
               texname = 'Giota0')

# end of new eft parameters
