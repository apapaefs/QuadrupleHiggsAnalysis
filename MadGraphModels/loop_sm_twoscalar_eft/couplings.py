...
GC_GGeta0 = Coupling(name = 'GC_GGeta0',
                 value = '-(complex(0,1)*Geta0)',
                 order = {'QED':1})

GC_GGiota0 = Coupling(name = 'GC_GGiota0',
                 value = '-(complex(0,1)*Giota0)',
                 order = {'QED':1})
...
GC_HHHHiota0 = Coupling(name = 'GC_HHHHiota0',
                value = '-24*complex(0,1)*C5/Lambda',
                order = {'QED':2})
