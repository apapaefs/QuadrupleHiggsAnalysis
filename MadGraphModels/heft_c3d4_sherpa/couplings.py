...
GC_HHH = Coupling(name = 'GC_HHH',
                  value = '-6*complex(0,1)*lam*v*(1 + c3)',
                  order = {'QED':1})

GC_GGHH = Coupling(name = 'GC_GGHH',
                   value = '(complex(0,1)*GH)/v',
                   order = {'HIG':1,'QCD':2})

GC_GGGHH = Coupling(name = 'GC_GGGHH',
                    value = '(G*GH)/v',
                    order = {'HIG':1,'QCD':3})

GC_GGGGHH = Coupling(name = 'GC_GGGGHH',
                     value = '-(complex(0,1)*G**2*GH)/v',
                     order = {'HIG':1,'QCD':4})

GC_GGHHH = Coupling(name = 'GC_GGHHH',
                    value = '-(2*complex(0,1)*GH)/v**2',
                    order = {'HIG':1,'QCD':2})

GC_GGGHHH = Coupling(name = 'GC_GGGHHH',
                     value = '-(2*G*GH)/v**2',
                     order = {'HIG':1,'QCD':3})

GC_GGGGHHH = Coupling(name = 'GC_GGGGHHH',
                      value = '(2*complex(0,1)*G**2*GH)/v**2',
                      order = {'HIG':1,'QCD':4})
