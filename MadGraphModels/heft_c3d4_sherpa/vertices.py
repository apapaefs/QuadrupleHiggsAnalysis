...
V_146 = Vertex(name = 'V_146',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.VVSS_HEFT ],
               couplings = {(0,0):C.GC_GGHH})

V_147 = Vertex(name = 'V_147',
               particles = [ P.G, P.G, P.H, P.H, P.H ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.VVSSS_HEFT ],
               couplings = {(0,0):C.GC_GGHHH})

V_148 = Vertex(name = 'V_148',
               particles = [ P.G, P.G, P.G, P.H, P.H ],
               color = [ 'f(1,2,3)' ],
               lorentz = [ L.VVVSS_HEFT ],
               couplings = {(0,0):C.GC_GGGHH})

V_149 = Vertex(name = 'V_149',
               particles = [ P.G, P.G, P.G, P.H, P.H, P.H ],
               color = [ 'f(1,2,3)' ],
               lorentz = [ L.VVVSSS_HEFT ],
               couplings = {(0,0):C.GC_GGGHHH})

V_150 = Vertex(name = 'V_150',
               particles = [ P.G, P.G, P.G, P.G, P.H, P.H ],
               color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
               lorentz = [ L.VVVVSS_HEFT1, L.VVVVSS_HEFT2, L.VVVVSS_HEFT3 ],
               couplings = {(1,1):C.GC_GGGGHH,(0,0):C.GC_GGGGHH,(2,2):C.GC_GGGGHH})

V_151 = Vertex(name = 'V_151',
               particles = [ P.G, P.G, P.G, P.G, P.H, P.H, P.H ],
               color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
               lorentz = [ L.VVVVSSS_HEFT1, L.VVVVSSS_HEFT2, L.VVVVSSS_HEFT3 ],
               couplings = {(1,1):C.GC_GGGGHHH,(0,0):C.GC_GGGGHHH,(2,2):C.GC_GGGGHHH})
